...
<head>
    ...
    <meta charset="UTF-8">
    <title> Jeremy Gross | About </title>
...
<body>
    ...
    <section class="about">
        <article>
            <img src="assets/img/profile.JPG" alt="Image accueil">
        </article>
        <article>
            <h2>
                And love breaks
            ...
            <p>
                ...
                the world.
                Join me on this visual journey and let's create timeless memories together.
            </p>
        </article>
    </section>
